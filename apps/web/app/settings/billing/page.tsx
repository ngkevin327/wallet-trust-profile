...
export default function BillingSettingsPage() {
  ...
  return (
    <div className="page-content">
      <PageHeader
        title="Billing"
        lead="Manage your subscription and payment method."
        backHref="/dashboard"
        backLabel="← Dashboard"
      />
      ...
      <div className="ui-card">
        <p className="text-sm text-slate-600">
          Current plan:{" "}
          <span className="font-display font-semibold capitalize text-brand-800">
            {plan ?? "…"}
          </span>
        </p>
        ...
        {plan === "free" ? (
          <p className="mt-6 text-xs text-slate-500">
            If you recently canceled Premium, your profile keeps public data; premium-only features
            lock at period end.
          </p>
        ) : null}
      </div>
